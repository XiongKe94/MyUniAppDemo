	...
	<view>
		...
		<block v-if="TabCur==0">
			...
			<view class="padding bg-white">
				<view class="flex flex-wrap">
					...
					<view class="basis-df"></view>
					<view class="basis-df bg-grey margin-xs padding-sm radius">sm 50%</view>
			...
			<view class="cu-bar bg-white margin-top solid-bottom">
				<view class="action">
					<text class="cuIcon text-blue"></text>垂直对齐(align)
				</view>
			</view>
			<view class="bg-white">
				...
				<view class="flex solid-bottom padding align-center">
					<view class="bg-grey padding-lg margin-xs radius">ColorUi</view>
					<view class="bg-grey padding-sm margin-xs radius">align-center</view>
				</view>
				<view class="flex solid-bottom padding align-end">
					<view class="bg-grey padding-lg margin-xs radius">ColorUi</view>
					<view class="bg-grey padding-sm margin-xs radius">align-end</view>
				</view>
			</view>
		</block>
		<!--grid布局-->
		<block v-if="TabCur==1">
			...
			<view class="bg-white padding">
				<view class="grid margin-bottom text-center" v-for="(item,index) in 5" :class="'col-'+(index+1)" :key="index">
					<view class="padding" :class="index%2==0?'bg-cyan':'bg-blue'" v-for="(index,indexs) in (index+1)*2" :key="indexs">{{indexs+1}}</view>
				</view>
			</view>
			<view class="cu-bar bg-white solid-bottom margin-top">
				<view class="action">
					<text class="text-blue cuIcon-title"></text>等高
				</view>
			</view>
			<view class="bg-white padding">
				<view class="grid col-4 grid-square">
					<view class="bg-img" v-for="(item,index) in avatar" :key="index" :style="'backgroundImage:url('+item+')'"></view>
				</view>
			</view>
		</block>
