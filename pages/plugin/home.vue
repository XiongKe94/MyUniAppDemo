<template name="plugin">
	<view>
		<scroll-view scroll-y="true" class="page">
			...
			<view class="cu-card">
				<view class="cu-item bg-img shadow-blur" :style="'background-image:url('+item.img+');animation:show '+((index+1)*0.2+1)+'s 1;'" v-for="(item,index) in list"
				 :key="index" @tap="toChild" :data-url="item.url">
